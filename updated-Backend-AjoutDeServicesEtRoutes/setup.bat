...
echo const uri ='%MONGODB_URI%'; >> "%SERVICE_FILE%"
echo const dbName ='%MONGODB_name%'; >> "%SERVICE_FILE%"
...
echo const uri ='%MONGODB_URI%'; >> "%ROUTE_FILE%"
echo const dbName ='%MONGODB_name%'; >> "%ROUTE_FILE%"
